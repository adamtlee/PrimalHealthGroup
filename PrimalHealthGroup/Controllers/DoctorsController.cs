...
namespace PrimalHealthGroup.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(PHGContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,FirstName,LastName,HireDate,Email,ConcentrationType")] Doctor doctor)
        {
